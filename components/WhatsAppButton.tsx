...
export default function WhatsAppButton({
  ...
  return (
    <a
      ...
      className={`inline-flex items-center justify-center w-full gap-2 bg-[#3A5FA8] hover:bg-[#182849] text-white font-medium py-3 px-4 rounded-xl transition-colors duration-200 ${className}`}
    >
