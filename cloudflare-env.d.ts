/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: f10dc297437759e5dc50fb135667b4d0)
// Runtime types generated with workerd@1.20260710.1 2024-12-30 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	IMAGES_BUCKET: R2Bucket;
	DB: D1Database;
	ASSETS: Fetcher;
	PUBLIC_R2_URL: "https://pub-880ad7b13f9d42539f7b05ebb89ad8f0.r2.dev";
	WHATSAPP_NUMBER: string;
	BUSINESS_NAME: string;
	WORKER_SELF_REFERENCE: Fetcher /* global-vision */;
}
